...
class ProClipperAudioProcessor final : public juce::AudioProcessor
{
public:
    ProClipperAudioProcessor();
    ~ProClipperAudioProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProClipperAudioProcessor)
};
